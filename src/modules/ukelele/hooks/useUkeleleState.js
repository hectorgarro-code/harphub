...
/**
 * Hook que encapsula todo el estado de UI y lógica musical del UkeleleMasterModal.
 */
export const useUkeleleState = () => {
    const [view, setView] = useState('explore');
    const [tuning] = useState(['A', 'E', 'C', 'G']);
    const [fretCount] = useState(14);
    ...
    const [stringModes, setStringModes] = useState([0, 0, 0, 0]);
    ...
    const playChord = (positions) => {
        ...
        sortedPos.forEach((pos, i) => {
            ...
            // Ukelele octaves are mostly in the 4th octave
            let octave = 4;
            if (pos.sIdx === 2 && pos.fIdx < 12) octave = 4; // C4 is the lowest
            // High G tuning (re-entrant), G is G4. A is A4. E is E4.
            // If they go past the 12th fret, maybe octave 5
