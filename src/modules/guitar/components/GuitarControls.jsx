...
import { GUITAR_CHORD_SHAPES } from '../data/chordShapes';
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="lg:col-span-2 pt-6 border-t border-slate-800/50">
                        <div className="flex items-start justify-between mb-4">
                            ...
                            {selectedVoicing && (
                                <span className="text-[10px] text-slate-500 font-bold">
                                    {GUITAR_CHORD_SHAPES[chordType]?.[selectedVoicing]
                        ...
                        <div className="flex flex-wrap gap-3">
                            {['C', 'A', 'G', 'E', 'D'].map(shape => {
                                const available = !!GUITAR_CHORD_SHAPES[chordType]?.[shape];
                                return (
                                    <button
                                        key={shape}
                                        disabled={!available}
                            ...
                            {(() => {
                                const hasCagedShapes = !!GUITAR_CHORD_SHAPES[chordType];
                                return (
                                    <button 
                                        onClick={generateSuggestions}
                                        disabled={hasCagedShapes}
                                        title={hasCagedShapes 
                                            ? "Este acorde ya tiene formas CAGED estándar." 
                        ...
                        {!selectedVoicing && GUITAR_CHORD_SHAPES[chordType] && (
