// ============================================================
// DATOS DEL JUEGO — Palabras musicales, intervalos, sets de cuerdas
// ============================================================
...
export const STRING_SETS = [
    ...
    { id: '345', label: 'Cuerdas 3, 4 y 5', indices: [2, 3, 4] },
    { id: '456', label: 'Cuerdas 4, 5 y 6', indices: [3, 4, 5] },
    { id: 'ALL', label: 'Todo el Diapasón', indices: [0, 1, 2, 3, 4, 5] }
];
