...
import { useUkeleleState }  from './ukelele/hooks/useUkeleleState';
import { useGameEngine }   from './ukelele/hooks/useGameEngine';
import UkeleleFretboard     from './ukelele/components/UkeleleFretboard';
import UkeleleControls      from './ukelele/components/UkeleleControls';
import UkeleleGamePanel     from './ukelele/components/UkeleleGamePanel';
...
/**
 * UkeleleMasterModal — Orquestador principal.
 * Ensambla hooks y componentes sin contener lógica propia.
 */
const UkeleleMasterModal = ({ isOpen, onClose, addPoints, unlockAchievement }) => {
    if (!isOpen) return null;

    const ukeleleState = useUkeleleState();
    const {
            ...
            <div className="max-w-7xl w-full mx-auto space-y-6 relative">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-slate-800 pb-8">
                        <div>
                            <h1 className="text-4xl font-black tracking-tighter bg-gradient-to-br from-white to-slate-500 bg-clip-text text-transparent">
                                UKELELE MASTER <span className="text-blue-500">PRO</span>
                            </h1>
                ...
                <main className="max-w-7xl mx-auto space-y-8">
                    ...
                    {view === 'games' && gameState === 'idle' && (
                        <UkeleleGamePanel startGame={startGame} />
                    )}
...
export default UkeleleMasterModal;